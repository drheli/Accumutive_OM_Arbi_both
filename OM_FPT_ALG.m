...
function [i,x_plus_rev,x_minus_rev,y_plus_rev,y_minus_rev,CAx_plus,CAx_minus,CAy_plus,CAy_minus,CAx_plus_sel, CAx_minus_sel,CAy_plus_sel, CAy_minus_sel, cout_one_plus, cout_one_minus, cout_two_plus, cout_two_minus, shift_o_plus, shift_o_minus,u_r,enable,res_enable,compare_frac,v_int_plus, v_int_minus,v_frac_plus, v_frac_minus,w_int_plus,w_int_minus,w_frac_plus, w_frac_minus,p_plus,p_minus,count] = OM_FPT_ALG(x_in_plus, x_in_minus, y_in_plus, y_in_minus, k,u_r,n_r)
% initialization step
% time_step: j
unrolling = 8;
persistent j;
...
%for j = 1:18
        ...
        y_plus_rev = y_in_plus;
        y_minus_rev = y_in_minus;
...
%         end
        ...
        for i = n_r:-1:0
            if i == n_r
                ...
                [w_frac_plus, w_frac_minus, shift_o_plus, shift_o_minus] = V_frac(v_frac_plus,v_frac_minus,i,i,k,res_enable,shift_ena);   
